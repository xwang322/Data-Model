...
for r in range(i+1):		
    ...
    # product type: overlap_coefficient distance
    if(matrix[2*r][1] == '' and matrix[2*r+1][1] == ''):
        ...
        FVmatrix[r][0] = simfunctions.overlap_coefficient(set(product_type1), set(product_type2))
    ...
    FVmatrix[r][1] = simfunctions.overlap_coefficient(set(product_name1), set(product_name2)) 

	#product segment: overlap_coefficient distance
    if(matrix[2*r][3] == '' and matrix[2*r+1][3] == ''):
        ...
        FVmatrix[r][2] = simfunctions.overlap_coefficient(set(product_seg1), set(product_seg2)) 
    ...
    if(matrix[2*r][4] == '' and matrix[2*r+1][4] == ''):
        ...
        FVmatrix[r][3] = simfunctions.overlap_coefficient(set(product_brand1), set(product_brand2)) 		
    ...
    if(matrix[2*r][5] == '' and matrix[2*r+1][5] == ''):
        ...
        FVmatrix[r][4] = simfunctions.overlap_coefficient(set(product_category1), set(product_category2))
...
x = open('5000Test5_string_processed_feature_vector.txt','w')
