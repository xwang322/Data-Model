...
for r in range(i+1):
    ...
    if(matrix[2*r][6] == '' and matrix[2*r+1][6] == ''):
        ...
        FVmatrix[r][21] = simfunctions.jaccard(set(product_long1), set(product_long2))
    # long: overlap_coefficient distance
    if(matrix[2*r][6] == '' and matrix[2*r+1][6] == ''):
        FVmatrix[r][22] = 999
    else:
        FVmatrix[r][22] = simfunctions.overlap_coefficient(set(product_long1), set(product_long2))
    # long: cosine distance
    if(matrix[2*r][6] == '' and matrix[2*r+1][6] == ''):
        FVmatrix[r][23] = 999
    else:
        FVmatrix[r][23] = simfunctions.cosine(set(product_long1), set(product_long2))
    # long: soft_tfidf distance
    if(matrix[2*r][6] == '' and matrix[2*r+1][6] == ''):
        FVmatrix[r][24] = 999
    else:
        FVmatrix[r][24] = simfunctions.soft_tfidf(set(product_long1), set(product_long2))
...
x = open('5000Sampling26_string_processed_feature_vector.txt','w')
