...
for r in range(i+1):
    ...
    FVmatrix[r][5] = simfunctions.soft_tfidf(set(product_name1), set(product_name2))
    #product name: overlap_coefficient score	
    FVmatrix[r][6] = simfunctions.overlap_coefficient(set(product_name1), set(product_name2))
    ...
    if(matrix[2*r][3] == '' and matrix[2*r+1][3] == ''):
        ...
        FVmatrix[r][9] = simfunctions.soft_tfidf(set(product_seg1), set(product_seg2)) 
    ...
    if(matrix[2*r][4] == '' and matrix[2*r+1][4] == ''):
        ...
        FVmatrix[r][10] = simfunctions.soft_tfidf(set(product_brand1), set(product_brand2)) 		
	#brand: jaro_winkler distance	
    if(matrix[2*r][4] == '' and matrix[2*r+1][4] == ''):
        FVmatrix[r][11] = 999
    else:
        FVmatrix[r][11] = simfunctions.jaro_winkler(matrix[2*r][4], matrix[2*r+1][4]) 
	#brand: jaccard distance	
    if(matrix[2*r][4] == '' and matrix[2*r+1][4] == ''):
        FVmatrix[r][12] = 999
    else:
        FVmatrix[r][12] = simfunctions.jaccard(set(product_brand1), set(product_brand2)) 
    ...
    if(matrix[2*r][6] == '' and matrix[2*r+1][6] == ''):
        ...
        FVmatrix[r][13] = simfunctions.jaccard(set(product_long1), set(product_long2))
    # long: overlap_coefficient distance
    if(matrix[2*r][6] == '' and matrix[2*r+1][6] == ''):
        FVmatrix[r][14] = 999
    else:
        FVmatrix[r][14] = simfunctions.overlap_coefficient(set(product_long1), set(product_long2))
    # long: cosine distance
    if(matrix[2*r][6] == '' and matrix[2*r+1][6] == ''):
        FVmatrix[r][15] = 999
    else:
        FVmatrix[r][15] = simfunctions.cosine(set(product_long1), set(product_long2))
    # long: soft_tfidf distance
    if(matrix[2*r][6] == '' and matrix[2*r+1][6] == ''):
        FVmatrix[r][16] = 999
    else:
        FVmatrix[r][16] = simfunctions.soft_tfidf(set(product_long1), set(product_long2))
...
x = open('5000Sampling28_string_processed_feature_vector.txt','w')
