...
matrix_s1=matrix[0:8000]
matrix_t1=matrix[8000:]
label_s1=label[0:8000]
label_t1 = label[8000:]
...
matrix_s1=matrix[2000:]#1000-5000
matrix_t1=matrix[0:2000]
label_s1=label[2000:]
label_t1 = label[0:2000]
...
matrix_s1=matrix[0:2000]#0-1000+2000-5000
for each in matrix[4000:]:
    matrix_s1.append(each)
print("length of matrix_s1:")
print(len(matrix_s1))

matrix_t1=matrix[2000:4000]

label_s1=np.concatenate((label[0:2000],label[4000:]), axis = 0)
print(label_s1)
print("length of label_s1:")
print(len(label_s1))

label_t1 = label[2000:4000]
...
matrix_s1=matrix[0:4000]#0-2000+3000-5000
for each in matrix[6000:]:
    matrix_s1.append(each)
print("length of matrix_s1:")
print(len(matrix_s1))

matrix_t1=matrix[4000:6000]

label_s1=np.concatenate((label[0:4000],label[6000:]), axis = 0)
print(label_s1)
print("length of label_s1:")
print(len(label_s1))

label_t1 = label[4000:6000]
...
matrix_s1=matrix[0:6000]#0-3000+4000-5000
for each in matrix[8000:]:
    matrix_s1.append(each)
print("length of matrix_s1:")
print(len(matrix_s1))

matrix_t1=matrix[6000:8000]

label_s1=np.concatenate((label[0:6000],label[8000:]), axis = 0)
print(label_s1)
print("length of label_s1:")
print(len(label_s1))

label_t1 = label[6000:8000]
