...
for r in range(i+1):
    ...
    FVmatrix[r][8] = simfunctions.cosine(set(product_name1), set(product_name2)) 
    ...
    if(matrix[2*r][3] == '' and matrix[2*r+1][3] == ''):
        ...
        FVmatrix[r][13] = simfunctions.cosine(set(product_seg1), set(product_seg2)) 
		
	#brand: needleman_wunsch distance	
    if(matrix[2*r][4] == '' and matrix[2*r+1][4] == ''):
        FVmatrix[r][14] = 999
    else:		
        FVmatrix[r][14] = simfunctions.needleman_wunsch(matrix[2*r][4], matrix[2*r+1][4])
    ...
    if(matrix[2*r][4] == '' and matrix[2*r+1][4] == ''):
        ...
        FVmatrix[r][18] = simfunctions.cosine(set(product_brand1), set(product_brand2)) 
    ...
    if(matrix[2*r][5] == '' and matrix[2*r+1][5] == ''):
        ...
        FVmatrix[r][23] = simfunctions.cosine(set(product_category1), set(product_category2))
...
x = open('5000Sampling15_string_processed_feature_vector.txt','w')
