...
for r in range(i+1):
    ...
    if(matrix[2*r][5] == '' and matrix[2*r+1][5] == ''):
        ...
        FVmatrix[r][13] = simfunctions.needleman_wunsch(matrix[2*r][5], matrix[2*r+1][5]) 		
    ...
    if(matrix[2*r][5] == '' and matrix[2*r+1][5] == ''):
        ...
        FVmatrix[r][14] = simfunctions.soft_tfidf(set(product_category1), set(product_category2))
...
x = open('5000Test13_string_processed_feature_vector.txt','w')
