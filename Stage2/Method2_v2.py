...
'''
print('royal consumer')
kset = trie.keys('royal consumer')
print(kset)
print("royal consumer" in kset) 
# print its frequency
print(trie["royal consumer"])
...
with open('one_word_test_data.txt', 'r') as z:
    lines = z.readlines()
    for line in lines:
        items = line.split(':')
        item_id = items[0]
...
with open('two_word_test_data.txt', 'r') as z:
    lines = z.readlines()
    for line in lines:
        items = line.split(':')
        item_id = items[0]
...
train_result3 = []
with open('three_word_test_data.txt', 'r') as z:
    lines = z.readlines()
    for line in lines:
        items = line.split(':')
        item_id = items[0]
...
m = open('Method2_result_v2_test_result.txt','w')
