...
with open('Y_missing.txt', 'r') as f:
...
with open('Y_missing.txt', 'r') as f:
    r = 0
    a = open('Y_missing_after_ID_extraction.txt','w')
    b = open('Y_obtained_after_ID_extraction.txt','w')
    lines = f.readlines()
    for i in lines:
        if FVmatrix[r][0] == 1:
...
with open('predictions_Y.txt', 'r') as f:
    ...
    with open('Y_obtained_after_ID_extraction.txt', 'r') as g:
    ...
    #print(original)	
f.close()	
with open('predictions_Y_after_ID.txt', 'w') as f:
