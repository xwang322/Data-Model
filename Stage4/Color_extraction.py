...
with open('X_missing_after_dimension_extraction.txt', 'r') as f:
    r = 0
    a = open('X_missing_after_color_extraction.txt','w')
    b = open('X_obtained_after_color_extraction.txt','w')
    lines = f.readlines()
    for i in lines:
        if FVmatrix[r][0] != 999:
            if FVmatrix[r][0] == 1:
...
f.close()
i = 0
with open('X_missing_after_color_extraction.txt', 'r') as f:
    for i, l in enumerate(f):
        pass
f.close()
print(i + 1)
...
with open('predictions_X_after_dimension.txt', 'r') as f:
    ...
    with open('X_obtained_after_color_extraction.txt', 'r') as g:
    ...
    #print(original)	
f.close()	
with open('predictions_X_after_color.txt', 'w') as f:
