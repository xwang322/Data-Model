...
for r in range(i+1):
    ...
    #jaccard distance
    FVmatrix[r][9] = simfunctions.jaccard(set(product_name1_lower), set(product_name2_lower))
    #overlap_coefficient distance
    FVmatrix[r][10] = simfunctions.overlap_coefficient(set(product_name1_lower), set(product_name2_lower))
    #cosine distance
    FVmatrix[r][11] = simfunctions.cosine(set(product_name1_lower), set(product_name2_lower))
    #soft_tfidf distance
    FVmatrix[r][12] = simfunctions.soft_tfidf(set(product_name1_lower), set(product_name2_lower))
	
    # working on 4 sets based method for product unit
    #jaccard distance
    FVmatrix[r][13] = simfunctions.jaccard(set(product_unit1_combination), set(product_unit2_combination))
    #overlap_coefficient distance
    FVmatrix[r][14] = simfunctions.overlap_coefficient(set(product_unit1_combination), set(product_unit2_combination))
    #cosine distance
    FVmatrix[r][15] = simfunctions.cosine(set(product_unit1_combination), set(product_unit2_combination))
    #soft_tfidf distance
    FVmatrix[r][16] = simfunctions.soft_tfidf(set(product_unit1_combination), set(product_unit2_combination))
