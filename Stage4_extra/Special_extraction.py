...
with open('predictions_missing_after_color_extraction.txt', 'r') as f:
    r = 0
    a = open('predictions_missing_after_special_extraction.txt','w')
    b = open('predictions_obtained_after_special_extraction.txt','w')
    lines = f.readlines()
    for i in lines:
        if label[r] != 999:
...
f.close()
i = 0
with open('predictions_missing_after_special_extraction.txt', 'r') as f:
    for i, l in enumerate(f):
        pass
f.close()
print(i + 1)
original = []
with open('predictions_after_color.txt', 'r') as f:
    lines_target = f.readlines()
    for each in lines_target:
        original.append(each)
    with open('predictions_obtained_after_special_extraction.txt', 'r') as g:
    ...
    #print(original)	
f.close()	
with open('predictions_after_special.txt', 'w') as f:
